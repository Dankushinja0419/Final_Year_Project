...
IL_002f:
	{
		...
		NullCheck(L_4);
		int32_t L_6 = L_5;
		SubAssetKey_t967FF027464BE1A80F87E1A8343D2B650439DCCB L_7 = (L_4)->GetAt(static_cast<il2cpp_array_size_t>(L_6));
	}
	{
		...
		il2cpp_codegen_runtime_class_init_inline(SubAssetKey_t967FF027464BE1A80F87E1A8343D2B650439DCCB_il2cpp_TypeInfo_var);
		bool L_13;
		L_13 = SubAssetKey_Equals_m4A176AC100A717456097488AF6FA3937EFC2B63F(((L_8)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_9))), L_12, il2cpp_rgctx_method(method->klass->rgctx_data, 1));
		if (!L_13)
		{
			goto IL_005b;
		}
