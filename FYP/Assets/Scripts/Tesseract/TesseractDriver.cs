...
public class TesseractDriver
{
    ...
    public string whitelist = "あいうえおかきくけこさしすせそたちつてとなにぬねのはひふへほまみむめもやゆよらりるれろわをん";
    //public string blacklist = "ァ-ン";
    ...
    public void OcrSetup(UnityAction onSetupComplete)
    {
        ...
        if (_tesseract.Init("jpn", datapath))
        {
            Debug.Log("Tesseract Tessdata Init Successful");
            _tesseract.SetWhitelist(whitelist);
            //_tesseract.SetBlacklist(blacklist);
